...
namespace IdentityManager
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IEmailSender, EmailJetEmailSender>();
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("FirstNameAuth", policy => policy.Requirements.Add(new FirstNameAuthRequirement("erhan")));
            });
